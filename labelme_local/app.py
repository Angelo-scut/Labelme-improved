...
from . import utils
from labelme_local.config import get_config
from labelme_local.label_file import LabelFile
from labelme_local.label_file import LabelFileError
from labelme_local.logger import logger
from labelme_local.shape import Shape
from labelme_local.widgets import BrightnessContrastDialog
from labelme_local.widgets import Canvas
from labelme_local.widgets import LabelDialog
from labelme_local.widgets import LabelListWidget
from labelme_local.widgets import LabelListWidgetItem
from labelme_local.widgets import ToolBar
from labelme_local.widgets import UniqueLabelQListWidget
from labelme_local.widgets import ZoomWidget
...
# 二次开发
# 1、action 2、createmode（canvas.py） 3、shapetype（shape.py)
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        self.labelList = LabelListWidget()  # 右边显示label的窗口
        self.lastOpenDir = None

        self.flag_dock = self.flag_widget = None
        self.flag_dock = QtWidgets.QDockWidget(self.tr("Flags"), self)
        self.flag_dock.setObjectName("Flags")
        self.flag_widget = QtWidgets.QListWidget()  # 右边flags的窗口
        if config["flags"]:
        ...
        self.labelList.itemDropped.connect(self.labelOrderChanged)  # 条目拖拉
        ...
        self.uniqLabelList = UniqueLabelQListWidget()  # 这个才是Label List那个浮动窗口的
        ...
        shortcuts = self._config["shortcuts"]  # shortcuts的意思是快捷键，在C:\Users\Wang\.labelmerc文件中设定了
        quit = action(
            self.tr("&Quit"),
            self.close,
            shortcuts["quit"],
        ...
        self.populateModeActions()  # 这里就是edit菜单栏的东西
    ...
    def loadFile(self, filename=None): #加载图片和label
        ...
        self.canvas.loadPixmap(QtGui.QPixmap.fromImage(image))  # canvas是画布的意思
